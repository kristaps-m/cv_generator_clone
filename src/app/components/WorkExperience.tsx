...
interface WorkExperienceProps {
    ...
    handleWorkExperienceChange: (index: number, data: React.ChangeEvent<HTMLInputElement>) => void;
    handleAddWorkExperience: () => void;
    handleRemoveWorkExperience: (index: number) => void;
}

const WorkExperience : React.FC<WorkExperienceProps> = ({ workExperiences,
     handleWorkExperienceChange, handleAddWorkExperience, handleRemoveWorkExperience }) => {
    return (
      <div>
        <Grid item xs={12}>
                  <Grid item xs={12}>
